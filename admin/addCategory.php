            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Add Category name</h4>
                      <form class="form-horizontal style-form" method="post">
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <input class="form-control" id="focusedInput" type="text" name="categoryName" placeholder="Enter category name">
                              </div>
                          </div>
                          <center><button type="submit" name="addcategory" class="btn btn-theme btn-primary btn-lg btn-block">Submit </button></center>
                      </form>
                  </div>
              </div><!-- col-lg-12-->       
            </div><!-- /row -->
