...
<?php 
  if (isset($_POST['addSubCategory'])) {
    ...
    echo $sql1 = "INSERT INTO `sub_category`(`category_id`, `sub_category_name`) VALUES ($category,'$subCategoryName')";
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="addSubCategory.php">add Sub-category</a></li>
            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Add Sub Category 1</h4>
                      <form class="form-horizontal style-form" method="post">
                          ...
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <input class="form-control" name="subCategoryName" id="focusedInput" type="text" placeholder="Enter Category name eg : Java ">
                              </div>
                          </div>
                          <center><button type="submit" name="addSubCategory" class="btn btn-theme btn-primary btn-lg btn-block">Submit </button></center>
                      </form>
                  </div>
              </div><!-- col-lg-12-->       
            </div><!-- /row -->
