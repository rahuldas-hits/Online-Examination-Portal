                          ...
                          <table class="table table-striped table-advance table-hover">
                            ...
                            <hr>
                              ...
                              <tr>
                                  ...
                                  <td><a href="basic_table.php#"> <?php echo $row['question']; ?> </a></td>
                                  ...
                                  <td>
                                      ...
                                      <a href="editQuestion.php?id=<?php echo $row['id'];?>" name="Edit" type="submit" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
