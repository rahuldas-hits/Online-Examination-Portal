...
<?php 
  if (isset($_POST['addqsn'])) {
    ...
    $sql = "SELECT total_question FROM test WHERE id = $testName";
    $res = mysqli_query($conn,$sql);        
    $row = mysqli_fetch_array($res); 
    $count = $row['total_question'];

    if ($_SESSION['capnum'] < $count - 1 ) {       
            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Add Questions <?php echo $_SESSION['capnum'] + 1 ;?> </h4>
