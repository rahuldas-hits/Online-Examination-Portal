...
?>
<?php 
  if (isset($_POST['addTestName'])) {
    $category = $_POST['category'];
    $subCategory = $_POST['subCategory'];
    $testname = $_POST['test_name'];
    $total = $_POST['total_question'];
    $positive = $_POST['positive_marks'];
    $negative = $_POST['negative_marks'];

    //sql query for entrying question
    $sql1 = "INSERT INTO `test`(`category`, `sub_category_id`, `Test_name`,`total_question`, `positive_marks`, `negative_marks`) VALUES ($category,$subCategory,'$testname',$total,$positive,$negative);";
              ...
              <div class="col-lg-12">
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post">
                          ...
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <input class="form-control" name="test_name" id="focusedInput" type="text" placeholder="Enter Test Paper name Eg : Mock Test 1">
                              </div>
                          </div>
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <input class="form-control" name="total_question" id="focusedInput" type="text" placeholder="Enter total number of question">
                              </div>
                          </div>
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <input class="form-control" name="positive_marks" id="focusedInput" type="text" placeholder="Enter positive mark Eg 1">
                              </div>
                          </div>
                          <div class="form-group">
                              <div class="col-sm-10">
                                  <input class="form-control" name="negative_marks" id="focusedInput" type="text" placeholder="Enter negative marks eg 1">
                              </div>
                          </div>
                          <center><button type="submit" name="addTestName" class="btn btn-theme btn-primary btn-lg btn-block">Submit </button></center>
                      </form>
                  </div>
              </div><!-- col-lg-12-->       
            </div><!-- /row -->
