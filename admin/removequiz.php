                          ...
                          <table class="table table-striped table-advance table-hover">
                            ...
                            <hr>
                              ...
                              <tr>
                                  ...
                                  <td><a href="basic_table.php#"> <?php echo $row['sub_category_name']; ?> </a></td>
                                  ...
                                  <td>
                                      ...
                                      <a href="editSubCategory.php?id=<?php echo $row['id'];?>" name="Edit" type="submit" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
