            ...
            <div class="page-body">
                <div class="row">
                    <div class="col-sm-12">
                                        ...
                                        <div class="row seacrh-header">
                                            <div class="input-group input-group-button input-group-primary">
                                                <select name="select_sub_code" class="form-control">
                                                  ...
                                                  <option class="dropdown-item" value="">Arrange by</option>
                        ...
                        <h4 class="m-b-20"><b>
                            <?php echo $_SESSION['row_count']; ?>
                        </b> Search Results Found</h4>
                        ...
                        <?php 
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $sql = "SELECT * FROM `test` WHERE Test_name LIKE '%$search_key%' ;";
                            }
                            
                            $result = mysqli_query($conn,$sql);
                            $rowcount=mysqli_num_rows($result);
                            $_SESSION['row_count'] = $rowcount;
