                    ...
                    <div class="login-card card-block auth-body">
                        <form class="md-float-material">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-b-20">
                                    <div class="col-md-6">
                                        <button class="btn btn-facebook m-b-20"><i class="icofont icofont-social-facebook"></i>Sign with facebook</button>
                                    </div>
                                    <div class="col-md-6">
                                        <button class="btn btn-twitter m-b-20"><i class="icofont icofont-social-twitter"></i>Sign with twitter</button>
                                    </div>
                                </div>
